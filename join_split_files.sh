...
cat system/system/priv-app/SamsungAvatarAuthoring_Lite/SamsungAvatarAuthoring_Lite.apk.* 2>/dev/null >> system/system/priv-app/SamsungAvatarAuthoring_Lite/SamsungAvatarAuthoring_Lite.apk
rm -f system/system/priv-app/SamsungAvatarAuthoring_Lite/SamsungAvatarAuthoring_Lite.apk.* 2>/dev/null
...
cat system/system/priv-app/BixbyService/BixbyService.apk.* 2>/dev/null >> system/system/priv-app/BixbyService/BixbyService.apk
rm -f system/system/priv-app/BixbyService/BixbyService.apk.* 2>/dev/null
